...
class LeNet5(layers.ModuleWrapper):
    ...
    def __init__(self):
        ...
        # Conv-BN-Tanh-Pool
        if flags.var1:
            self.conv1 = layers.ConvVarianceBe(1, int(20*flags.width), 5, padding=0, bias=False)
        else:
        ...
        # Conv-BN-Tanh-Pool
        if flags.var2:
            self.conv2 = layers.ConvVarianceBe(int(20*flags.width), int(50*flags.width), 5, padding=0, bias=False)
        else:
        ...
        # Dense-BN-Tanh
        if flags.var3:
            self.dense1 = layers.LinearVarianceBe(int(800*flags.width), int(500*flags.width), bias=False)
        else:
        ...
        # Dense
        if flags.var4:
            self.dense2 = layers.LinearVarianceBe(int(500*flags.width), 10, bias=False)
        else:
